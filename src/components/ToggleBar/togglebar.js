    ...
    return (
        <div className={`toggleBar ${visibility ? 'active' : ''}`}>
            ...
            <svg id="home_img" className="ipc-logo" xmlns="http://www.w3.org/2000/svg" 
                 width="128" height="64" viewBox="0 0 64 32" version="1.1"><g fill="#F5C518">
                     <rect x="0" y="0" width="100%" height="100%" rx="4"></rect></g>
                ...
                <span onClick={TogglebarVissibility} className="close">X</span>
            </div>
